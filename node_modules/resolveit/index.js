 ...
 * 
 *  1. Explode the basedir into all possible paths
...
// Main
//---------------------------------------------------------------------------
function resolveSync (path, basedir, opts) {
    var found, foundpath, dirIsAbs;
    
    if (arguments < 3 && !isArray(basedir) && typeof basedir === 'object') {
        opts = basedir;
        basedir = null;
    }
 ...
 * @param {String|Array[String]|Object} [opts] base directories to search,
