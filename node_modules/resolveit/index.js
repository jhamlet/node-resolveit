...
module.exports = Object.defineProperties({
     ...
     * @param {String|Array[String]} [basedir = process.cwd()] base directories to search,
     ...
     *          @returns {String|Array[String]} these will be appended to the search
        ...
        paths = buildPaths(search, opts)[findAll ? 'filter' : 'some'](
            function (filepath) {
                var path    = filepath.toString(),
                    ...
                    matches = stat && allowDirs ? isDir : isFile;
